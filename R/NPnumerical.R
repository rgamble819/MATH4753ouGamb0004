...
#' Newton-Raphson algorithm to find numerical solution of derivative
#'
#' @param x0 # initial guess
#' @param delta # step size
#' @param llik # likliness function
#' @param xrange # how for to examine on graph
#' @param parameter # label for parameter on axis
#' @examples
